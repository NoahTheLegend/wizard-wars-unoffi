...
void onTick(CBlob@ this)
{
	...
	else
	{
		if (this.get_u32("launch_delay") <= getGameTime())
		{
			...
			{
				this.getSprite().PlaySound("ManaGain.ogg", 0.35f, 1.75f + XORRandom(26)*0.01f);
				this.Tag("had_sound");
			}
...
void onCollision( CBlob@ this, CBlob@ blob, bool solid, Vec2f normal)
{
	if (solid || doesCollideWithBlob(this, blob))
	{
		if (blob !is null)
		{
			...
			this.server_Hit(blob, blob.getPosition(), blob.getVelocity(), 0.33f, Hitters::explosion, true);
		}
