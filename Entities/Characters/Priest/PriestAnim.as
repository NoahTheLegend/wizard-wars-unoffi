...
{
	RunnerTextures@ runner_tex = addRunnerTextures(this, "priest", "Priest");
...
void onTick( CSprite@ this )
{
	...
	if (blob.isKeyPressed(key_action1))
		spell_ready = PriestParams::spells[playerPrefsInfo.primarySpellID].needs_full ? entro.charge_state >= PriestParams::cast_3 : entro.charge_state >= PriestParams::cast_1;
	else if (blob.isKeyPressed(key_action2))
		spell_ready = PriestParams::spells[Maths::Min(playerPrefsInfo.hotbarAssignments_Priest[15], spellsLength-1)].needs_full ? entro.charge_state >= PriestParams::cast_3 : entro.charge_state >= PriestParams::cast_1;
	bool full_charge = entro.charge_state == PriestParams::extra_ready;
	needs_shiny = spell_ready;
	needs_shiny2 = entro.charge_state >= PriestParams::charging;
