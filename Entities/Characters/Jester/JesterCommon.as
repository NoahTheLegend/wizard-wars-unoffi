...
namespace JesterParams
{
	...
	const ::Spell[] spells = 
	{
		Spell("jestergas", "Rejoicing Gas", 108, "In misty shroud, foes gasp and wheeze, as dense gas spreads with sinister ease.",
			SpellCategory::offensive, SpellType::other, 3, 18, 0, 360.0f, false, false, array<int> = {SpellAttribute::SPELL_PROJECTILE}),
		...
		Spell("flowerpad", "Flower Pad", 109, "From earth's embrace, a bloom does rise, bouncing softly, under clear skies.",
			SpellCategory::utility, SpellType::other, 5, 30, 0, 128.0f, false, true, array<int> = {SpellAttribute::SPELL_MOVEMENT, SpellAttribute::SPELL_GROUNDED}),

		Spell("mitten", "Enchanted Mitten", 110, "A mitten alive, fingers strong and bold, casting bullet hell, its power untold.",
			SpellCategory::offensive, SpellType::other, 20, 20, 1, 256.0f, true, false, array<int> = {SpellAttribute::SPELL_CASTEREFFECT, SpellAttribute::SPELL_SHIFT}),

		Spell("bobomb", "BOB-omb", 120, "Bob, the walking bomb, with a heart so warm, explodes with love.",
			SpellCategory::summoning, SpellType::other, 35, 45, 8, 128.0f, true, true, array<int> = {SpellAttribute::SPELL_SUMMON}),
		...
		Spell("baseballbat", "Bat", 116, "Spinning bat of Jester's grace, erases foes without a trace.",
			SpellCategory::offensive, SpellType::other, 35, 45, 8, 256.0f, true, false, array<int> = {SpellAttribute::SPELL_PROJECTILE, SpellAttribute::SPELL_KNOCKBACK}),
		
		Spell("tophat", "Possessed Tophat", 117, "Possessed tophat with mystic deals, dropping bombs and giving heals.",
			SpellCategory::summoning, SpellType::other, 65, 60, 20, 312.0f, true, false, array<int> = {SpellAttribute::SPELL_SUMMON, SpellAttribute::SPELL_HEAL}),
			
		Spell("bashster", "Bashster", 119, "Knocking blast, a foe's overthrow, hold to charge, let it grow.",
			SpellCategory::offensive, SpellType::other, 30, 45, 6, 256.0f, true, false, array<int> = {SpellAttribute::SPELL_PROJECTILE}),
