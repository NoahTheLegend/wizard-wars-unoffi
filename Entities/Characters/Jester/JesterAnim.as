...
{
	RunnerTextures@ runner_tex = addRunnerTextures(this, "jester", "Jester");
...
const bool firing = blob.isKeyPressed(key_action1) || blob.isKeyPressed(key_action2);;
	...
	if (blob.isKeyPressed(key_action1))
		spell_ready = JesterParams::spells[playerPrefsInfo.primarySpellID].needs_full ? jester.charge_state >= JesterParams::cast_3 : jester.charge_state >= JesterParams::cast_1;
	else if (blob.isKeyPressed(key_action2))
		spell_ready = JesterParams::spells[Maths::Min(playerPrefsInfo.hotbarAssignments_Jester[15], spellsLength-1)].needs_full ? jester.charge_state >= JesterParams::cast_3 : jester.charge_state >= JesterParams::cast_1;
	bool full_charge = jester.charge_state == JesterParams::extra_ready;
	needs_shiny = spell_ready;
	needs_shiny2 = jester.charge_state >= JesterParams::charging;
