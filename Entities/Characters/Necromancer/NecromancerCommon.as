...
namespace NecromancerParams
{
	...
	const ::Spell[] spells = 
	{
		...
		Spell("teleport", "Teleport to Target", 40, "Point to any visible position and teleport there.",
			SpellCategory::special, SpellType::other, 25, 6, 0, 270.0f, true, 0, NecromancerSpellAttributesCollection[NecromancerSpells::TELEPORT_NECROMANCER]),
		...
		Spell("slow", "Slow", 19, "Deprive a player of his speed and ability to teleport for a few moments.",
			SpellCategory::debuff, SpellType::other, 15, 30, 0, 360.0f, true, 0, NecromancerSpellAttributesCollection[NecromancerSpells::SLOW_NECROMANCER]), 
			 
		Spell("zombie", "Summon a Zombie", 2, "Summon an undead minion to fight by your side.",
			SpellCategory::summoning, SpellType::summoning, 18, 15, 0, 64.0f, true, 0, NecromancerSpellAttributesCollection[NecromancerSpells::ZOMBIE]),
		...
		Spell("arrow_rain", "Arrow Rain", 22, "Cause a long volley of randomly assorted arrows to fall upon thy foe. Great for area denial, and possibly overpowered!",
			SpellCategory::offensive, SpellType::other, 60, 60, 10, 360.0f, true, 0, NecromancerSpellAttributesCollection[NecromancerSpells::ARROW_RAIN]),
		...
		Spell("leech_g", "Leech", 130, "Fire a short-ranged arc of dark energy which steals the life-force from foes and revitalizes you.",
			SpellCategory::offensive, SpellType::other, 22, 40, 3, 180.0f, true, 0, NecromancerSpellAttributesCollection[NecromancerSpells::LEECH]),
		...
		Spell("force_of_nature", "Force of Nature", 27, "By invoking this spell, you call into being an orb of ghastly green light which destroys anything foolish enough to cross its path, including you!",
			SpellCategory::offensive, SpellType::other, 40, 30, 3, 360.0f, true, 0, NecromancerSpellAttributesCollection[NecromancerSpells::FORCE_OF_NATURE]),
		...
		Spell("no_teleport_barrier", "Teleport Blocker", 49, "Prevents enemies from teleporting past this barrier.",
			SpellCategory::utility, SpellType::other, 10, 10, 0, 100.0f, true, 0, NecromancerSpellAttributesCollection[NecromancerSpells::NO_TELEPORT_BARRIER]),
