...
{
	RunnerTextures@ runner_tex = addRunnerTextures(this, "entropist", "Entropist");
...
{
    string texname = "EntropistMale.png";
...
void onTick( CSprite@ this )
{
    ...
    EntropistInfo@ entro;
	if (!blob.get( "entropistInfo", @entro )) 
	{
		return;
	}
	...
	if (blob.isKeyPressed(key_action1))
		spell_ready = EntropistParams::spells[playerPrefsInfo.primarySpellID].needs_full ? entro.charge_state >= EntropistParams::cast_3 : entro.charge_state >= EntropistParams::cast_1;
	else if (blob.isKeyPressed(key_action2))
		spell_ready = EntropistParams::spells[Maths::Min(playerPrefsInfo.hotbarAssignments_Entropist[15], spellsLength-1)].needs_full ? entro.charge_state >= EntropistParams::cast_3 : entro.charge_state >= EntropistParams::cast_1;
	bool full_charge = entro.charge_state == EntropistParams::extra_ready;
	needs_shiny = spell_ready;
	needs_shiny2 = entro.charge_state >= EntropistParams::charging;
