...
const f32 min_hallowed_barrier_dmg = 0.2f;
...
namespace PaladinParams
{
	...
	const ::Spell[] spells = 
	{
		Spell("templarhammer", "Templar Hammer", 92, "Throws a magic hammer that is affected by gravity.",
				SpellCategory::offensive, SpellType::other, 4, 25, 0, 120.0f, false, 0, PaladinSpellAttributesCollection[PaladinSpells::TEMPLAR_HAMMER]),

		Spell("teleport", "Teleport to Target", 40, "Point to any visible position and teleport there.",
			SpellCategory::special, SpellType::other, 20, 6, 0, 270.0f, true, 0, PaladinSpellAttributesCollection[PaladinSpells::TELEPORT_PALADIN]),
		...
		Spell("celestialcrush", "Heavenly Crush", 91, "Summons a heavy hammer to smash nearby area with a delay. Launches everything upwards. Weaker near cliffs.",
				SpellCategory::offensive, SpellType::other, 8, 40, 1, 256.0f, true, 1, PaladinSpellAttributesCollection[PaladinSpells::HEAVENLY_CRUSH]),
		...
		Spell("manatohealth", "Aura: Sigma", 94, "Doubles heal taken. Disables replenishing mana at obelisks. Increases damage taken by "+((aura_sigma_damage_mod_self-1.0f)*100)+"%",
				SpellCategory::heal, SpellType::other, 0, 15, 3, 0, true, 0, PaladinSpellAttributesCollection[PaladinSpells::AURA_SIGMA]),
		...
		Spell("majestyglyph", "Glyph of Majesty", 98, "Decreases spell cooldown by "+((1.0f-glyph_cooldown_reduction)*100)+"%.",
				SpellCategory::support, SpellType::other, 10, 30, 8, 96.0f, true, 0, PaladinSpellAttributesCollection[PaladinSpells::GLYPH_OF_MAJESTY]),
				
		Spell("sealofwisdom", "Seal of Wisdom", 99, "Applies an effect to wipe any other debuff.",
				SpellCategory::support, SpellType::other, 15, 40, 6, 256.0f, true, 0, PaladinSpellAttributesCollection[PaladinSpells::SEAL_OF_WISDOM]),
		...
		Spell("noblelance", "Noble Lance", 100, "Casts a piercing lance to move at aim position. Goes back to caster position after reaching destination.",
				SpellCategory::offensive, SpellType::other, 20, 45, 0, 298.0f, false, 0, PaladinSpellAttributesCollection[PaladinSpells::NOBLE_LANCE]),
		...
		Spell("faithglaive", "Faith Glaive", 102, "Releases a short-range glaive to slash in front of you. The spell disables teleport and awaits some time before attack.",
				SpellCategory::offensive, SpellType::other, 18, 30, 1, 0.0f, false, 0, PaladinSpellAttributesCollection[PaladinSpells::FAITH_GLAIVE]),
		...
		Spell("blesscircle", "Circle of Bless", 103, "Sets mana regeneration to maximum (+1) for everyone inside. Enemies also claim this effect. Doesnt stack. Can be dispelled by anyone.",
				SpellCategory::support, SpellType::other, 10, 30, 18, 198.0f, true, 0, PaladinSpellAttributesCollection[PaladinSpells::CIRCLE_OF_BLESS]),
		...
		Spell("knight_revive", "Revive", 106, "Summon a noble warrior back from the dead with aiming a reviving missile at their gravestone.",
				SpellCategory::support, SpellType::other, 75, 60, 10, 256.0f, true, 0, PaladinSpellAttributesCollection[PaladinSpells::KNIGHT_REVIVE]),
		...
		Spell("fury", "Holy Angel", 101, "Summon an Angel releasing blades at enemies nearby. Overcharge increases her damage and fire rate.",
				SpellCategory::summoning, SpellType::other, 75, 75, 16, 64.0f, true, 0, PaladinSpellAttributesCollection[PaladinSpells::HOLY_ANGEL]),
		...
		Spell("heal", "Lesser Heal", 14, "Salves the least of your allies' wounds to restore a moderate portion of their health. Fully charge in order to heal yourself with less efficiency.",
			SpellCategory::heal, SpellType::other, 30, 45, 7, 360.0f, true, 0, WizardSpellAttributesCollection[WizardSpellAttributes::HEAL]), 			 
