...
void InitClasses(CBlob@ this)
{
	...
	addPlayerClass(this, "Necromancer", "$necromancer_class_icon$", "necromancer", "It smells rotten.");
	//addPlayerClass(this, "Knight", "$knight_class_icon$", "knight", "Hack and Slash.");
	...
	addPlayerClass(this, "Warlock", "$warlock_class_icon$", "warlock", "Bozo.");
}
...
void buildSpawnMenu(CBlob@ this, CBlob@ caller)
{
	...
	//WizWars-------------------
	AddIconToken("$wizard_class_icon$", "GUI/ClassIcons.png", Vec2f(32, 32), 2, caller.getTeamNum());
	AddIconToken("$necromancer_class_icon$", "GUI/ClassIcons.png", Vec2f(32, 32), 3, caller.getTeamNum());
	//AddIconToken("$knight_class_icon$", "GUI/ClassIcons.png", Vec2f(32, 32), 0, caller.getTeamNum());
